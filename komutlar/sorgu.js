...
module.exports.run = async (client, message, args) => {
 ...
 if(!kullanıcı) {
    ...
    if(sekiz === null) sekiz = "0"
    if(sekiz === undefined) sekiz = "0"
    ...
    • Toplam 18+ Kayıtların: \`${sekiz}\`
    • Toplam 16-18 Kayıtların: \`${erkek}\`
    • Toplam 13-15 Kayıtların: \`${kadın}\`
    `)
    .setFooter("Alper ❤️ Register")
...
let sekiz1 = db.fetch(`yetkili.${message.author.id}.sekiz`);
...
if(sekiz1 === null) sekiz1 = "0"
if(sekiz1 === undefined) sekiz1 = "0"
...
.setDescription(`• Toplam Kayıtların: \`${kayıtlar1}\`
    • Toplam 18+ Kayıtların: \`${sekiz1}\`
    • Toplam 16-18 Kayıtların: \`${erkek1}\`
    • Toplam 13-15 Kayıtların: \`${kadin1}\`
`)
.setFooter("Alper ❤️ Register")
