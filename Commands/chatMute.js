...
module.exports.execute = async (client, message, args) => {
    ...
    let embed = new MessageEmbed().setTitle(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter('♆ C A T H E D R A').setColor("RANDOM").setTimestamp();
